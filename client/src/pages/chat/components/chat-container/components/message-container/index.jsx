                            ...
                            >
                                <img src={`${HOST}/${message.fileUrl}`} height={300} width={300} />
                                 ...
                                 <div className="flex items-center justify-center gap-4 ">
                                     ...
                                     <span className="bg-black/20 p-3 text-2xl rounded-full hover:bg-black/50 cursor-pointer transition-all
                                     duration-300 " onClick={()=>downloadFile(message.fileUrl)}>
                                        <IoMdArrowRoundDown />
                                     </span>
                                     </div>
                        ...
                        <img src= {`${HOST}/${imageURL}`} className="h-[80vh] w-full bg-cover " />
                          ...
                          <div className="flex gap-5 fixed top-0 mt-5 "> 
                            <button className="bg-black/20 p-3 text-2xl rounded-full hover:bg-black/50 cursor-pointer transition-all
                                     duration-300 " onClick={()=>downloadFile(imageURL)}>
