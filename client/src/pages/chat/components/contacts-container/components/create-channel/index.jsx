         ...
         <TooltipProvider>
            <Tooltip>
               <TooltipTrigger>
                ...
                duration-300" onClick={()=> setNewChannelModal(true)} />
          ...
          <div>
            ...
            defaultOptions ={allContacts} placeholder="Search Contacts" value={selectedContacts} onChange={setSelectedContacts} 
            emptyIndicator={
