...
const Auth =()=>{
    ...
    return(
        <div className="h-[100vh] w-[100vw] flex items-center justify-center">
            ...
            <div className="h-[80vh] bg-white border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw]
            rounded-3xl grid xl:grid-cols-2">
                ...
                <div className="flex flex-col gap-10 items-center justify-center">
                    <div className="flex items-center justify-center flex-col">
                        ...
                        <p className="font-medium text-center">Fill in the details to get start with best chat-app!</p>
                        </div>
                        ...
                        <div className="flex items-center justify-center w-full"> 
                            ...
                            <Tabs className="w-3/4" defaultValue="login">
                                ...
                                <Input type ="email" className="rounded-full p-6 "  placeholder="Email" value={email} onChange ={(e)=>setEmail(e.target.value)}/>
                              ...
                              <Input  type ="password" 
                            placeholder="Password" className="rounded-full p-6 " value={password} onChange ={(e)=>setpassword(e.target.value)}/>    


                             <Input type ="password" className="rounded-full p-6 "  placeholder="Confirm Password" value={confirmpasssword} onChange ={(e)=>setconfirmpassword(e.target.value)}/>
