...
const NewDM =()=>{
  ...
  const {setSelectedChatType,setSelectedChatData} =useAppStore()
    ...
    const [openNewContactModel,setOpenNewContactModal] =useState(false)
    ...
    return(
        <>
         <TooltipProvider>
            <Tooltip>
               <TooltipTrigger>
                <FaPlus className="text-neutral-400 font-light text-opacity-90 text-sm hover:text-neutral-100 cursor-pointer transition-all
                duration-300" onClick={()=> setOpenNewContactModal(true)} />
            ...
            <div className="flex flex-col gap-5">
              {
                searchedContacts.map((contact)=>(
                  <div key={contact._id} className="flex gap-3  items-center cursor-pointers" onClick={()=>selectNewContact(contact)}>
          ...
          </ScrollArea> )}
          {
            searchedContacts.length <=0 && (
                ...
                <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-300 text-center">
                  ...
                  <h3 className="poppins-medium">Hii
